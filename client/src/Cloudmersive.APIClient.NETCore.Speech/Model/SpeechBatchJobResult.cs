...
{
    /// <summary>
    /// Result of submitting a Speech batch job
    /// </summary>
    [DataContract]
    public partial class SpeechBatchJobResult :  IEquatable<SpeechBatchJobResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpeechBatchJobResult" /> class.
        /// </summary>
        ...
        public SpeechBatchJobResult(bool? successful = default(bool?), string asyncJobID = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SpeechBatchJobResult {\n");
        ...
        {
            return this.Equals(input as SpeechBatchJobResult);
        }

        /// <summary>
        /// Returns true if SpeechBatchJobResult instances are equal
        /// </summary>
        /// <param name="input">Instance of SpeechBatchJobResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SpeechBatchJobResult input)
        {
            if (input == null)
                return false;
